...
export const MESSAGES = {
  ...
  elixirEnergized: "THE INGREDIENTS SWIRL VIGOROUSLY AND BEGIN TO GLOW WITH WARM MAGICAL ENERGY.",
  elixirAlreadyEnergized: "THE ELIXIR IS ALREADY GLOWING WITH ENERGIZED MAGICAL ENERGY.",
  pourEnergizedElixir: "YOU POUR THE ENERGIZED ELIXIR OVER THE SLEEPING PRINCESS. A SHIMMERING AURA ENVELOPS HER FORM.",
  pourDullElixir: "YOU POUR THE DULL ELIXIR, BUT NOTHING HAPPENS. THE INGREDIENTS WERE NOT ENERGIZED.",
  sabrinaAwakeTalk: "PRINCESS SABRINA SAYS, 'LET'S GET OUT OF HERE!'",
  sabrinaSleepingTalk: "THE SLEEPING PRINCESS IS DEEP IN A MAGICAL SLUMBER AND CANNOT HEAR YOU.",
  whomToSpeak: "TO WHOM DO YOU WISH TO SPEAK?",
