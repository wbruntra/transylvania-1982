...
`,q=new WeakMap;function J(e,t){(q.get(e)??e).setAttribute(`transform`,t)}function Y(e){return q.get(e)??e}function X(e,t){let n=document.createElementNS(`http://www.w3.org/2000/svg`,`g`),r=document.createElementNS(`http://www.w3.org/2000/svg`,`g`);n.appendChild(r),q.set(r,n),r.setAttribute(`class`,`scene-prop-interactive`),r.setAttribute(`tabindex`,`0`),r.setAttribute(`role`,`button`),r.setAttribute(`aria-label`,e);let i=document.createElementNS(`http://www.w3.org/2000/svg`,`title`);return i.textContent=`${e} (Click to interact)`,r.appendChild(i),t&&(r.addEventListener(`click`,e=>{e.stopPropagation(),t()}),r.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),e.stopPropagation(),t())})),r}function Ct(e,t,n){if(t.objectLoc[18]===3){let t=X(`Wrinkled Note`,()=>n?.(`get note`));J(t,`translate(530, 770) rotate(-6)`),t.innerHTML+=`
  ...
  `,e.appendChild(Y(r))}function jt(e,t,n){if(t.objectLoc[32]===20){let t=X(`Garlic Clove`,()=>n?.(`get garlic`));J(t,`translate(490, 520)`),t.innerHTML+=`
    ...
    `,e.appendChild(Y(a))}function Ht(e,t,n){let r=X(`Ravenous Mice`,()=>n?.(`look mice`));J(r,`translate(512, 820)`),r.innerHTML+=`
