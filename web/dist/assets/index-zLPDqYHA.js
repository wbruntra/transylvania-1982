...
`,X=new WeakMap;function Z(e,t){(X.get(e)??e).setAttribute(`transform`,t)}function Q(e){return X.get(e)??e}function $(e,t){let n=document.createElementNS(`http://www.w3.org/2000/svg`,`g`),r=document.createElementNS(`http://www.w3.org/2000/svg`,`g`);n.appendChild(r),X.set(r,n),r.setAttribute(`class`,`scene-prop-interactive`),r.setAttribute(`tabindex`,`0`),r.setAttribute(`role`,`button`),r.setAttribute(`aria-label`,e);let i=document.createElementNS(`http://www.w3.org/2000/svg`,`title`);return i.textContent=`${e} (Click to interact)`,r.appendChild(i),t&&(r.addEventListener(`click`,e=>{e.stopPropagation(),t()}),r.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),e.stopPropagation(),t())})),r}function yt(e,t,n){if(t.objectLoc[18]===3){let t=$(`Wrinkled Note`,()=>n?.(`get note`));Z(t,`translate(530, 770) rotate(-6)`),t.innerHTML+=`
    ...
    `,e.appendChild(Q(t))}}function bt(e,t,n){if(t.objectLoc[28]===4){let t=$(`Glowing Extraterrestrial Saucer`,()=>n?.(`look saucer`));Z(t,`translate(512, 690)`),t.innerHTML+=`
    ...
    `,e.appendChild(Q(t))}}function xt(e,t,n){if(t.objectLoc[6]===5){let t=$(`Wooden Cross`,()=>n?.(`get cross`));Z(t,`translate(310, 680)`),t.innerHTML+=`
      <!-- Cross shadow -->
    ...
    `,e.appendChild(Q(t))}if(t.objectLoc[13]===5){let r=t.flags.GT===1,i=$(r?`Open Shaft Down to Catacombs`:`Locked Rusty Iron Grate`,()=>n?.(r?`go down`:`unlock grate`));Z(i,`translate(660, 750)`),r?i.innerHTML+=`
      ...
      `,e.appendChild(Q(i))}}function St(e,t,n){if(t.objectLoc[1]===7){let t=$(`Bottle of Weak Acid`,()=>n?.(`get acid`));Z(t,`translate(280, 520)`),t.innerHTML+=`
    ...
    `,e.appendChild(Q(t))}}function Ct(e,t,n){if(t.objectLoc[7]===9){let t=$(`Swarm of Buzzing Flies`,()=>n?.(`catch flies`));Z(t,`translate(420, 480)`),t.innerHTML+=`
    ...
    `,e.appendChild(Q(t))}}function wt(e,t,n){if(t.objectLoc[8]===16){let t=$(`Plump Bullfrog`,()=>n?.(`feed frog`));Z(t,`translate(340, 800)`),t.innerHTML+=`
    ...
    `,e.appendChild(Q(t))}}function Tt(e,t,n){if(t.objectLoc[36]===11){let t=$(`Magic Elixir`,()=>n?.(`get elixir`));Z(t,`translate(512, 650)`),t.innerHTML+=`
      <!-- Altar shadow -->
    ...
    `,e.appendChild(Q(t))}}function Et(e,t,n){let r=$(`Wooden Warning Sign`,()=>n?.(`read sign`));Z(r,`translate(450, 620) rotate(-4)`),r.innerHTML+=`
  ...
  `,e.appendChild(Q(r))}function Dt(e,t,n){if(t.objectLoc[32]===20){let t=$(`Garlic Clove`,()=>n?.(`get garlic`));Z(t,`translate(490, 520)`),t.innerHTML+=`
      <!-- Hanging hemp string -->
    ...
    `,e.appendChild(Q(t))}}function Ot(e,t,n){if(t.objectLoc[3]===22){let t=$(`Dusty Wizard's Cloak`,()=>n?.(`get cloak`));Z(t,`translate(420, 520)`),t.innerHTML+=`
      <!-- Wall peg -->
    ...
    `,e.appendChild(Q(t))}}function kt(e,t,n){if(t.objectLoc[9]===24){let t=$(`Loaf of Stale Bread`,()=>n?.(`get bread`));Z(t,`translate(512, 680)`),t.innerHTML+=`
      <!-- Table cutting board -->
    ...
    `,e.appendChild(Q(t))}}function At(e,t,n){if(t.objectLoc[17]===25){let t=$(`Flintlock Pistol`,()=>n?.(`get pistol`));Z(t,`translate(512, 720) rotate(-8)`),t.innerHTML+=`
    ...
    `,e.appendChild(Q(t))}}function jt(e,t,n){if(t.objectLoc[10]===26){let t=$(`Sneering Goblin with Key`,()=>n?.(`say ijnid`));Z(t,`translate(512, 740)`),t.innerHTML+=`
      <!-- Sand shadow -->
    ...
    `,e.appendChild(Q(t))}}function Mt(e,t,n){if(t.flags.WF===1){let t=$(`Pile of Werewolf Ashes`,()=>n?.(`look ash`));Z(t,`translate(512, 750)`),t.innerHTML+=`
      <!-- Ash mound shadow -->
    ...
    `,e.appendChild(Q(t))}}function Nt(e,t,n){if(t.objectLoc[31]===29){let t=$(`Piece of Flypaper`,()=>n?.(`get flypaper`));Z(t,`translate(660, 480)`),t.innerHTML+=`
      <!-- Ceiling thumbtack -->
    ...
    `,e.appendChild(Q(t))}}function Pt(e,t,n){if(t.flags.VR===1){let t=$(`Smoldering Vampire Embers`,()=>n?.(`look embers`));Z(t,`translate(512, 740)`),t.innerHTML+=`
    ...
    `,e.appendChild(Q(t))}}function Ft(e,t,n){let r=t.objectLoc[4]===35,i=t.objectLoc[5]===35,a=$(r?i?`Open Coffer with Shiny Ring`:`Open Coffer`:`Locked Treasure Coffer`,()=>n?.(r?i?`get ring`:`look coffer`:`open coffer`));Z(a,`translate(512, 720)`),r?a.innerHTML+=`
    ...
    `,e.appendChild(Q(a))}function It(e,t,n){if(t.objectLoc[38]===37){let t=$(`Princess Sabrina (Awake)`,()=>n?.(`talk princess`));Z(t,`translate(512, 740)`),t.innerHTML+=`
      <!-- Aura of liberation -->
    ...
    `,e.appendChild(Q(t))}}function Lt(e,t,n){let r=t.objectLoc[19]===38,i=t.objectLoc[22]===38,a=$(r?`Open Wooden Coffin`:`Closed Wooden Coffin`,()=>n?.(r?i?`get bullet`:`look coffin`:`open coffin`));Z(a,`translate(512, 700)`),r?a.innerHTML+=`
      <!-- Open coffin base -->
    ...
    `,e.appendChild(Q(a))}function Rt(e,t,n){let r=$(`Ravenous Mice`,()=>n?.(`look mice`));Z(r,`translate(512, 820)`),r.innerHTML+=`
  ...
  `,e.appendChild(Q(r))}function zt(e,t,n){let r=$(`Snarling Werewolf`,()=>n?.(`shoot werewolf`));Z(r,`translate(512, 740)`),r.innerHTML+=`
  ...
  `,e.appendChild(Q(r))}function Bt(e,t,n){let r=$(`Lethal Vampire`,()=>n?.(`wave cross`));Z(r,`translate(512, 740)`),r.innerHTML+=`
    <!-- Shadow -->
  ...
  `,e.appendChild(Q(r))}function Vt(e,{roomId:t,state:n,world:r,onAction:i}){if(e){switch(e.innerHTML=vt,t){case 3:yt(e,n,i);break;case 4:bt(e,n,i);break;case 5:xt(e,n,i);break;case 7:St(e,n,i);break;case 9:Ct(e,n,i);break;case 10:break;case 11:Tt(e,n,i);break;case 15:Et(e,n,i);break;case 16:wt(e,n,i);break;case 20:Dt(e,n,i);break;case 22:Ot(e,n,i);break;case 24:kt(e,n,i);break;case 25:At(e,n,i);break;case 26:jt(e,n,i);break;case 27:Mt(e,n,i);break;case 29:Nt(e,n,i);break;case 30:Pt(e,n,i);break;case 35:Ft(e,n,i);break;case 37:It(e,n,i);break;case 38:Lt(e,n,i)}n.objectLoc[20]===t&&Rt(e,n,i),n.objectLoc[34]===t&&!n.flags.WF&&zt(e,n,i),n.objectLoc[39]===t&&!n.flags.VR&&Bt(e,n,i)}}var Ht={1:[`#0d3311`,`#7fd18b`],2:[`#1a1a2e`,`#8b8bd1`],4:[`#331a0d`,`#d1a67f`],5:[`#330d1f`,`#d17fa6`],6:[`#222`,`#aaa`],7:[`#101`,`#5ff`],8:[`#000`,`#333`]},Ut=Ht[1],Wt={1:e=>e.flags.SM?`-runes`:``,9:e=>e.flags.DR?`-open`:``,10:e=>e.flags.DR?`-open`:``,4:e=>e.objectLoc[2]===-1?`-burnt`:``,37:e=>e.objectLoc[16]===37?`-open`:e.objectLoc[15]===37?`-sarcophagus`:e.objectLoc[38]===-1?``:`-empty`},Gt=`transylvania-art-mode`;function Kt(e,t,n=`enhanced`){if(t?.isGameOver&&(t?.gameOverReason===`win`||!t?.isDead&&t?.objectLoc?.[38]===-2))return[`art/victory.webp`,`art/victory.jpg`,`art/victory.png`];let r=t?Wt[e.id]?.(t)??``:``,i=[`art/room-${e.id}${r}.webp`,`art/room-${e.id}.webp`,`art/room-${e.id}.png`];return n===`classic`?[`art/classic/room-${e.id}.webp`,...i]:i}function qt(e,t,n,r){let i=document.createElement(`img`);i.className=`scene-art`,i.alt=``,e.prepend(i);let a=document.getElementById(`sceneBackdrop`),o=(()=>{try{return localStorage.getItem(Gt)===`classic`?`classic`:`enhanced`}catch{return`enhanced`}})(),s=null;function c(t){i.style.display=`none`;let[n,r]=Ht[t.type]??Ut;e.style.background=`radial-gradient(circle at 50% 30%, ${r}, ${n} 70%)`,a&&(a.style.backgroundImage=`none`,a.style.background=`radial-gradient(circle at 50% 50%, ${r}, ${n} 80%)`,a.style.opacity=`0.35`)}return i.onload=()=>{a&&i.src&&(a.style.backgroundImage=`url("${i.src}")`,a.style.opacity=`0.45`)},{show(a,l,u){s={room:a,state:l,world:u};let d=Kt(a,l,o);e.style.background=`#000`,i.style.display=`block`;function f(){let e=d.shift();e?i.src=e:c(a)}i.onerror=f,f(),n&&l&&u&&(l.isGameOver&&(l.gameOverReason===`win`||!l.isDead&&l.objectLoc?.[38]===-2)?n.innerHTML=``:Vt(n,{roomId:a.id,state:l,world:u,onAction:r})),t.textContent=l?.isGameOver?l.gameOverReason===`win`||!l.isDead&&l.objectLoc?.[38]===-2?`VICTORY · KING'S CASTLE`:`GAME OVER · ROOM ${a.id}`:`ROOM ${a.id} · TYPE ${a.type}`},getArtMode(){return o},toggleArtMode(){o=o===`classic`?`enhanced`:`classic`;try{localStorage.setItem(Gt,o)}catch{}return s&&this.show(s.room,s.state,s.world),o}}}function Jt(e,t,n){if(!e||!t||!n)return[];if(t.isGameOver)return[{cmd:`restart`,label:`RESTART GAME`,icon:`🔄`}];let r=[],i=e.id;t.objectLoc[34]===i&&!t.flags?.WF&&r.push({cmd:`shoot werewolf`,label:`SHOOT WEREWOLF`,icon:`🐺`,danger:!0}),t.objectLoc[39]===i&&!t.flags?.VR&&u(t,6)&&r.push({cmd:`wave cross`,label:`WAVE CROSS`,icon:`✝️`,danger:!0}),t.objectLoc[20]===i&&u(t,25)&&r.push({cmd:`wave broom`,label:`WAVE BROOM`,icon:`🧹`});let a=A(n,t,i);for(let e of a)if(m(n,t,e.id)){if(i===7&&t.objectLoc[24]===7&&(e.id===1||e.id===25))continue;let a=f(n,t,e.id),o=`📦`,s=`get ${a.toLowerCase().replace(/\.$/,``)}`;e.id===18?(o=`📜`,s=`get note`):e.id===20?(o=`🐀`,s=`get mice`):e.id===32?(o=`🧄`,s=`get garlic`):e.id===3?(o=`🧥`,s=`get cloak`):e.id===26?(o=`🗝️`,s=`get pick`):e.id===17?(o=`🔫`,s=`get pistol`):e.id===22?(o=`⚪`,s=`get bullet`):e.id===6?(o=`✝️`,s=`get cross`):e.id===31?(o=`🪰`,s=`get flypaper`):e.id===11?(o=`🔑`,s=`get key`):e.id===36?(o=`🧪`,s=`get elixir`):e.id===25?(o=`🧹`,s=`get broom`):e.id===1?(o=`🧪`,s=`get acid`):e.id===9?(o=`🍞`,s=`get bread`):e.id===5&&(o=`💍`,s=`get ring`),r.push({cmd:s,label:`GET ${a.replace(/\.$/,``).toUpperCase()}`,icon:o})}i===1?(r.push({cmd:`look stump`,label:`LOOK STUMP`,icon:`🪵`}),t.flags?.SM&&(r.push({cmd:`go stump`,label:`ENTER STUMP`,icon:`🚪`}),r.push({cmd:`knock stump`,label:`KNOCK STUMP`,icon:`🚪`}))):i===4?r.push({cmd:`look statue`,label:`LOOK STATUE`,icon:`🛸`}):i===5?!t.flags?.GT&&t.objectLoc[13]!==5?r.push({cmd:`open grate`,label:`OPEN GRATE`,icon:`🕳️`}):r.push({cmd:`down`,label:`CLIMB DOWN`,icon:`🕳️`}):i===9||i===10?(i===9&&t.objectLoc[7]===9&&r.push({cmd:`look flies`,label:`LOOK FLIES`,icon:`🪰`}),i===9&&t.objectLoc[31]===9&&r.push({cmd:`get flypaper`,label:`GET FLYPAPER`,icon:`🪰`}),t.flags?.DR?r.push({cmd:`go door`,label:`GO DOOR`,icon:`🚪`}):r.push({cmd:`open door`,label:`OPEN DOOR`,icon:`🚪`})):i===7?t.objectLoc[24]===7&&r.push({cmd:`look cat`,label:`LOOK CAT`,icon:`🐱`}):i===16?r.push({cmd:`look frog`,label:`LOOK FROG`,icon:`🐸`}):i===21?(r.push({cmd:`look antlers`,label:`LOOK ANTLERS`,icon:`🦌`}),r.push({cmd:`pull antlers`,label:`PULL ANTLERS`,icon:`🦌`})):i===22?r.push({cmd:`pull wall`,label:`REVOLVE WALL`,icon:`🔄`}):i===24||i===38?r.push({cmd:`open coffin`,label:`OPEN COFFIN`,icon:`⚰️`}):i===25||i===33?(r.push({cmd:`board boat`,label:`BOARD BOAT`,icon:`⛵`}),r.push({cmd:`sail boat`,label:`SAIL BOAT`,icon:`⛵`})):i===26?r.push({cmd:`look goblin`,label:`LOOK GOBLIN`,icon:`👺`}):i===37&&(t.flags?.SH?t.flags?.PO?r.push({cmd:`look damsel`,label:`LOOK SABRINA`,icon:`👸`}):r.push({cmd:`open coffin`,label:`OPEN COFFIN`,icon:`⚰️`}):r.push({cmd:`cut vines`,label:`PULL VINES`,icon:`🌿`})),u(t,18)&&r.push({cmd:`read note`,label:`READ NOTE`,icon:`📖`}),u(t,17)&&u(t,22)&&r.push({cmd:`load pistol`,label:`LOAD PISTOL`,icon:`⚙️`}),u(t,3)&&r.push({cmd:`wear cloak`,label:`WEAR CLOAK`,icon:`🧥`}),u(t,25)&&t.objectLoc[24]!==i&&r.push({cmd:`ride broom`,label:`RIDE BROOM`,icon:`🧹`}),r.length<3&&(r.push({cmd:`look`,label:`LOOK AROUND`,icon:`👁️`}),r.push({cmd:`inventory`,label:`INVENTORY`,icon:`🎒`}));let o=new Set,s=[];for(let e of r)o.has(e.cmd)||(o.add(e.cmd),s.push(e));return s}function Yt({onCommand:e}){let t=document.getElementById(`log`),n=document.getElementById(`cmd`),r=document.getElementById(`go`),i=document.getElementById(`actionChips`),a=document.querySelectorAll(`.dpad-btn`),o=document.querySelectorAll(`.quick-btn`),s=document.getElementById(`dirs`);function c(){let t=n.value;n.value=``,e(t)}if(r&&r.addEventListener(`click`,e=>{e.stopPropagation(),c()}),n&&n.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),e.stopPropagation(),c())}),a.forEach(t=>{let n=t.dataset.dir,r=t.dataset.cmd;t.addEventListener(`click`,()=>{n?e(n):r&&e(r)})}),o.forEach(t=>{let n=t.dataset.cmd;n&&t.addEventListener(`click`,()=>e(n))}),s&&s.children.length===0)for(let t of[`N`,`S`,`W`,`E`,`U`,`D`,`LOOK`,`MAP`,`INVENTORY`]){let n=document.createElement(`button`);n.textContent=t,n.addEventListener(`click`,()=>e(t.toLowerCase())),s.append(n)}function l(e,t){if(!e)return;let n=e.exits||{},r=!!t?.isGameOver,i={n:!r&&n.N>0,s:!r&&n.S>0,w:!r&&n.W>0,e:!r&&n.E>0,u:!r&&n.U>0,d:!r&&(n.D>0||e.id===5&&!!t?.flags?.GT)};a.forEach(e=>{let t=e.dataset.dir;t&&t in i&&(i[t]?(e.classList.add(`active-exit`),e.classList.remove(`disabled-exit`),e.setAttribute(`aria-disabled`,`false`)):(e.classList.remove(`active-exit`),e.classList.add(`disabled-exit`),e.setAttribute(`aria-disabled`,`true`)))})}function u(t,n,r){if(!i)return;let a=Jt(t,n,r);i.replaceChildren(...a.map(t=>{let n=document.createElement(`button`);return n.type=`button`,n.className=`action-chip ${t.danger?`danger`:``}`,n.innerHTML=`${t.icon?`<span class="chip-icon">${t.icon}</span>`:``}<span class="chip-label">${t.label}</span>`,n.addEventListener(`click`,()=>{e(t.cmd)}),n}))}return{print(e){t&&e.length!==0&&(t.textContent+=`${e.join(`
`)}\n`,t.scrollTop=t.scrollHeight)},echo(e){this.print([`> ${e}`])},clear(){t&&(t.textContent=``,t.scrollTop=0)},focus(){n&&n.focus()},update({room:e,state:t,world:i}){l(e,t),u(e,t,i),n&&(t?.isGameOver?(n.disabled=!0,n.blur()):n.disabled=!1),r&&(r.disabled=!!t?.isGameOver)}}}async function Xt(){let e=Xe(await n(),{randomEvents:!0,debugInventory:q()}),t=e=>{},r=qt(document.getElementById(`scene`),document.getElementById(`sceneLabel`),document.getElementById(`sceneOverlay`),e=>t(e)),i=ot(document.getElementById(`scene`),document.getElementById(`log`)),a=document.getElementById(`mapToggle`),o=document.getElementById(`artToggle`),s=document.getElementById(`artToggleLabel`);function c(){if(!o)return;let e=r.getArtMode()===`classic`;o.classList.toggle(`active`,e),s&&(s.textContent=e?`1982`:`CLASSIC`),o.title=e?`Switch to illustrated graphics`:`Switch to 1982 Apple II graphics`}o&&(o.addEventListener(`click`,()=>{r.toggleArtMode(),c()}),c());let l=document.getElementById(`debugToggle`);l&&(l.classList.toggle(`active`,q()),l.addEventListener(`click`,()=>{et(),location.reload()}));let u=_t({miniMapElement:document.getElementById(`miniMap`),miniMapViewport:document.getElementById(`miniMapViewport`),miniMapBadge:document.getElementById(`miniMapBadge`),drawerElement:document.getElementById(`mapDrawer`),drawerBody:document.getElementById(`mapDrawerBody`),drawerStats:document.getElementById(`mapDrawerStats`),drawerClose:document.getElementById(`mapDrawerClose`),drawerBackdrop:document.getElementById(`mapDrawerBackdrop`)});a&&a.addEventListener(`click`,()=>{u.toggle()});function d(){u.update({currentRoom:e.state.room,visitedRooms:e.getVisitedRooms(),world:e.world,state:e.state})}let f=ut({overlayElement:document.getElementById(`gameOverOverlay`),onRestart:()=>t(`restart`)}),p,m=0,h=!1,g=()=>{let t=e.world.room(e.state.room);if(r.show(t,e.state,e.world),d(),p&&p.update({room:t,state:e.state,world:e.world}),e.isGameOver()){h||=(m=Date.now(),!0);let t=Ze(e.state);f.show(t)}else h=!1,m=0,f.hide()},_=$e({engine:e,onJump:g}),v=e.state.room;function y(){e.state.room!==v&&(v=e.state.room,p.clear())}let b=document.getElementById(`turnBadge`);function x(){b&&(b.textContent=`TURN ${e.state.turns}`)}t=function(t){if(e.isGameOver()){if(Date.now()-m<400)return;t=`restart`}let n=t.trim().toLowerCase();n===`map`||n===`m`?u.open():(n===`scene`||n===`close`&&u.isOpen())&&u.close();let r=_.handle(t);if(r!==null){Promise.resolve(r).then(e=>{y(),p.echo(t),p.print(e),x(),d(),g()});return}i.prime();let{echo:a,messages:o,events:s}=e.execute(t);a!==null&&(y(),p.echo(a),p.print(o),g(),x(),s?.length&&i.play(s))},window.addEventListener(`keydown`,n=>{e.isGameOver()&&(Date.now()-m<450||[`Shift`,`Control`,`Alt`,`Meta`,`CapsLock`,`Tab`].includes(n.key)||((n.key===` `||n.key===`Enter`)&&n.preventDefault(),t(`restart`)))}),p=Yt({onCommand:t}),p.print(e.start()),x(),d();let S=_.initialRoom();S!==null&&(e.state.room=S,y(),p.print([`DEBUG: resumed at room ${S}`,e.world.room(S).desc])),g(),p.focus()}Xt().catch(e=>{console.error(e);let t=document.getElementById(`log`);t&&(t.textContent+=`\nFAILED TO START: ${e.message}\n`)});