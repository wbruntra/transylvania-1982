...
`,X=new WeakMap;function Z(e,t){(X.get(e)??e).setAttribute(`transform`,t)}function Q(e){return X.get(e)??e}function $(e,t){let n=document.createElementNS(`http://www.w3.org/2000/svg`,`g`),r=document.createElementNS(`http://www.w3.org/2000/svg`,`g`);n.appendChild(r),X.set(r,n),r.setAttribute(`class`,`scene-prop-interactive`),r.setAttribute(`tabindex`,`0`),r.setAttribute(`role`,`button`),r.setAttribute(`aria-label`,e);let i=document.createElementNS(`http://www.w3.org/2000/svg`,`title`);return i.textContent=`${e} (Click to interact)`,r.appendChild(i),t&&(r.addEventListener(`click`,e=>{e.stopPropagation(),t()}),r.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),e.stopPropagation(),t())})),r}function gt(e,t,n){if(t.objectLoc[18]===3){let t=$(`Wrinkled Note`,()=>n?.(`get note`));Z(t,`translate(530, 770) rotate(-6)`),t.innerHTML+=`
    ...
    `,e.appendChild(Q(t))}}function _t(e,t,n){if(t.objectLoc[28]===4){let t=$(`Glowing Extraterrestrial Saucer`,()=>n?.(`look saucer`));Z(t,`translate(512, 690)`),t.innerHTML+=`
    ...
    `,e.appendChild(Q(t))}}function vt(e,t,n){if(t.objectLoc[6]===5){let t=$(`Wooden Cross`,()=>n?.(`get cross`));Z(t,`translate(310, 680)`),t.innerHTML+=`
      <!-- Cross shadow -->
    ...
    `,e.appendChild(Q(t))}if(t.objectLoc[13]===5){let r=t.flags.GT===1,i=$(r?`Open Shaft Down to Catacombs`:`Locked Rusty Iron Grate`,()=>n?.(r?`go down`:`unlock grate`));Z(i,`translate(660, 750)`),r?i.innerHTML+=`
      ...
      `,e.appendChild(Q(i))}}function yt(e,t,n){if(t.objectLoc[1]===7){let t=$(`Bottle of Weak Acid`,()=>n?.(`get acid`));Z(t,`translate(280, 520)`),t.innerHTML+=`
    ...
    `,e.appendChild(Q(t))}}function bt(e,t,n){if(t.objectLoc[7]===9){let t=$(`Swarm of Buzzing Flies`,()=>n?.(`catch flies`));Z(t,`translate(420, 480)`),t.innerHTML+=`
    ...
    `,e.appendChild(Q(t))}}function xt(e,t,n){if(t.objectLoc[8]===16){let t=$(`Plump Bullfrog`,()=>n?.(`feed frog`));Z(t,`translate(340, 800)`),t.innerHTML+=`
    ...
    `,e.appendChild(Q(t))}}function St(e,t,n){if(t.objectLoc[36]===11){let t=$(`Magic Elixir`,()=>n?.(`get elixir`));Z(t,`translate(512, 650)`),t.innerHTML+=`
      <!-- Altar shadow -->
    ...
    `,e.appendChild(Q(t))}}function Ct(e,t,n){let r=$(`Wooden Warning Sign`,()=>n?.(`read sign`));Z(r,`translate(450, 620) rotate(-4)`),r.innerHTML+=`
  ...
  `,e.appendChild(Q(r))}function wt(e,t,n){if(t.objectLoc[32]===20){let t=$(`Garlic Clove`,()=>n?.(`get garlic`));Z(t,`translate(490, 520)`),t.innerHTML+=`
      <!-- Hanging hemp string -->
    ...
    `,e.appendChild(Q(t))}}function Tt(e,t,n){if(t.objectLoc[3]===22){let t=$(`Dusty Wizard's Cloak`,()=>n?.(`get cloak`));Z(t,`translate(420, 520)`),t.innerHTML+=`
      <!-- Wall peg -->
    ...
    `,e.appendChild(Q(t))}}function Et(e,t,n){if(t.objectLoc[9]===24){let t=$(`Loaf of Stale Bread`,()=>n?.(`get bread`));Z(t,`translate(512, 680)`),t.innerHTML+=`
      <!-- Table cutting board -->
    ...
    `,e.appendChild(Q(t))}}function Dt(e,t,n){if(t.objectLoc[17]===25){let t=$(`Flintlock Pistol`,()=>n?.(`get pistol`));Z(t,`translate(512, 720) rotate(-8)`),t.innerHTML+=`
    ...
    `,e.appendChild(Q(t))}}function Ot(e,t,n){if(t.objectLoc[10]===26){let t=$(`Sneering Goblin with Key`,()=>n?.(`say ijnid`));Z(t,`translate(512, 740)`),t.innerHTML+=`
      <!-- Sand shadow -->
    ...
    `,e.appendChild(Q(t))}}function kt(e,t,n){if(t.flags.WF===1){let t=$(`Pile of Werewolf Ashes`,()=>n?.(`look ash`));Z(t,`translate(512, 750)`),t.innerHTML+=`
      <!-- Ash mound shadow -->
    ...
    `,e.appendChild(Q(t))}}function At(e,t,n){if(t.objectLoc[31]===29){let t=$(`Piece of Flypaper`,()=>n?.(`get flypaper`));Z(t,`translate(660, 480)`),t.innerHTML+=`
      <!-- Ceiling thumbtack -->
    ...
    `,e.appendChild(Q(t))}}function jt(e,t,n){if(t.flags.VR===1){let t=$(`Smoldering Vampire Embers`,()=>n?.(`look embers`));Z(t,`translate(512, 740)`),t.innerHTML+=`
    ...
    `,e.appendChild(Q(t))}}function Mt(e,t,n){let r=t.objectLoc[4]===35,i=t.objectLoc[5]===35,a=$(r?i?`Open Coffer with Shiny Ring`:`Open Coffer`:`Locked Treasure Coffer`,()=>n?.(r?i?`get ring`:`look coffer`:`open coffer`));Z(a,`translate(512, 720)`),r?a.innerHTML+=`
    ...
    `,e.appendChild(Q(a))}function Nt(e,t,n){if(t.objectLoc[38]===37){let t=$(`Princess Sabrina (Awake)`,()=>n?.(`talk princess`));Z(t,`translate(512, 740)`),t.innerHTML+=`
      <!-- Aura of liberation -->
    ...
    `,e.appendChild(Q(t))}}function Pt(e,t,n){let r=t.objectLoc[19]===38,i=t.objectLoc[22]===38,a=$(r?`Open Wooden Coffin`:`Closed Wooden Coffin`,()=>n?.(r?i?`get bullet`:`look coffin`:`open coffin`));Z(a,`translate(512, 700)`),r?a.innerHTML+=`
      <!-- Open coffin base -->
    ...
    `,e.appendChild(Q(a))}function Ft(e,t,n){let r=$(`Ravenous Mice`,()=>n?.(`look mice`));Z(r,`translate(512, 820)`),r.innerHTML+=`
  ...
  `,e.appendChild(Q(r))}function It(e,t,n){let r=$(`Snarling Werewolf`,()=>n?.(`shoot werewolf`));Z(r,`translate(512, 740)`),r.innerHTML+=`
  ...
  `,e.appendChild(Q(r))}function Lt(e,t,n){let r=$(`Lethal Vampire`,()=>n?.(`wave cross`));Z(r,`translate(512, 740)`),r.innerHTML+=`
    <!-- Shadow -->
